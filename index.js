...
+ 'VERSION:3.0\n'
+ 'FN:𝕷𝖔𝖗𝖉.𝕭𝖔𝖙 𝕽𝖊𝖆𝖕𝖊𝖗 𝖛3🌹࿐\n' // Nama
+ 'ORG:𝕷𝖔𝖗𝖉.𝕭𝖔𝖙 𝕽𝖊𝖆𝖕𝖊𝖗 𝖛3🌹࿐;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=523131134857:+52 313 113 4857\n' // Nomor bot
+ 'END:VCARD' 
...
Usa ${prefix}verify para verificarte y poder usar el bot.`
				...
				num = anu.participants[0]
				teks = `Que bueno que te fuiste @${num.split('@')[0]} no te queriamos gonorrea 👋`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
pok = await getBuffer(nimek)
Lxa.sendMessage(from, pok, image, {
  quoted: mek, caption: `Lord.Bot-Reaper`
})
